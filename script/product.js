...
displaySpecificCategory(result)
}
...
const displayAllCategory = (categories) => {
    ...
    allBtn.className = "border border-indigo-900 rounded-full px-6 py-2 text-indigo-800 text-base font-bold capitalize cursor-pointer"
    allBtn.addEventListener("click", ()=> loadAllProduct())
